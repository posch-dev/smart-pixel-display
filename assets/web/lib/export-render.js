...
function rPalette(mode) {
  ...
  return {
    ...
    bg:     _rVar('--bg', '#0d0d0d'),
    accent: _rVar('--accent', DEFAULT_ACCENT),
    np1: _rVar('--np1', '') || _rVar('--accent', DEFAULT_ACCENT),
    glow: _rVar('--np-glow', '') || _rVar('--np1', '') || _rVar('--accent', DEFAULT_ACCENT),
    track: _rVar('--np-track', '') || _rVar('--border', '#2a2a2a'),
    title: _rVar('--np-title', '') || _rVar('--np1', '') || _rVar('--accent', DEFAULT_ACCENT),
    ...
    np2: _rVar('--np2', '') || _rVar('--accent-hd', '') || _rVar('--accent', DEFAULT_ACCENT),
    np3: _rVar('--np3', '') || _rVar('--np1', '') || _rVar('--accent', DEFAULT_ACCENT),
    cl:  _rVar('--cl', '') || _rVar('--accent', DEFAULT_ACCENT),
    vs:  _rVar('--vs', '') || _rVar('--accent', DEFAULT_ACCENT),
  };
}
